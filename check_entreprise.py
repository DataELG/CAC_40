...
# Add day data of the day before to history - LAUNCH ON MORNING - A VERIFIER LE 14 aout pour historique veille
...
#         insert_history(history_table, session_companies_table, boursorama_cie_ID,data)
...
#             key_id = get_id(companies_table,boursorama_cie_ID,session_companies_table) # OK
